...
public class ApplicationController {	
	...
	public ResponseEntity<String> handlerMethod1(@RequestHeader String header){
		ResponseEntity<String> responseEntity = new ResponseEntity<String>(header, HttpStatus.OK);
	...
	public ResponseEntity<String> handlerMethod2(@RequestHeader(name = "header") String value){
		ResponseEntity<String> responseEntity = new ResponseEntity<String>(value, HttpStatus.OK);
	...
	public ResponseEntity<Map<String, Object>> handlerMethod5(@RequestHeader Map<String, Object> headerMap){
		ResponseEntity<Map<String, Object>> responseEntity = new ResponseEntity<Map<String, Object>>(headerMap, HttpStatus.OK);
	...
	public ResponseEntity<MultiValueMap<String, Object>> handlerMethod6(@RequestHeader MultiValueMap<String, Object> headerMap){
		ResponseEntity<MultiValueMap<String, Object>> responseEntity = new ResponseEntity<MultiValueMap<String, Object>>(headerMap, HttpStatus.OK);
